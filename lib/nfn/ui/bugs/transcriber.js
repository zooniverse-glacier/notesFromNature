...
nfn.ui.view.Bugs = nfn.ui.view.Transcriber.extend({
    ...
    this.guide = [
      {
        ...
        description: 'These are the map coordinates where the specimen was found. Usually, latitude is written first. Many older labels will not have this information. There are many formats for reporting these coordinates. Two that are common are Degree- Minute- Second (37 56\' 49" N 121 58\' 17" W) and Decimal degrees (37.94718 -121.97146). Latitude will always refer to north (N) or south (S) and longitude east (E) or west (W) for the degree-minute-second format. For decimal degrees, the convention is east of Greenwich is positive, and north of the equator is positive, while west of Greenwich and south of the equator are shown as with a negative sign. Keep in mind that latitude can only be absolute numbers between 0 and 90 and longitude between 0 and 180.',
  ...
  startTranscribing: function() {
    ...
    //   , helperY = this.transcriberWidget.top() - this.helper.height() - 10;
    // this.helper.setTop(helperY);
    // this.helper.show();
  ...
  updateHelper: function() {
    ...
    console.log('tw', this.transcriberWidget.width());
    console.log('sGw', stepGuide.width);
