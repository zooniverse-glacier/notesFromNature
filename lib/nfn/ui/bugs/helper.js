...
nfn.ui.view.BugsHelper = nfn.ui.view.Widget.extend({
  ...
  initialize: function() {
    _.bindAll( this, "toggle", "updateTitle", "updateDescription", 'updateWidth', "showExample", "closeTooltip", "nextPhoto" );
  ...
  updateWidth: function() {
    ...
    console.log('twl', this.parent.transcriberWidget.left());
    console.log('tww', this.parent.transcriberWidget.width());
    this.setWidth(this.model.get('width'), true);
