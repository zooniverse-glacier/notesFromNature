...
nfn.ui.view.BugsHelper = nfn.ui.view.Widget.extend({
  ...
  initialize: function() {
    _.bindAll( this, "toggle", "updateTitle", "updateDescription", 'onWidthChange', 'onHeightChange', "showExample", "closeTooltip", "nextPhoto" );
  ...
  updateTitle: function() {
    ...
    if (that.model.get('required')) {
      title = title + '- <span class="required">Required</span>'
    } else {
  ...
  onWidthChange: function() {
    ...
    console.log('tc', transcriberCenter);
    this.setLeft(transcriberCenter - (this.width() / 2), true);
  },

  onHeightChange: function() {
    transcriberTop = this.parent.transcriberWidget.top();
    this.setTop(transcriberTop - this.height() - 10, true);
  },
