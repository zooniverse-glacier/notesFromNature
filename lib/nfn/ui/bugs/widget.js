...
nfn.ui.view.BugsWidget = nfn.ui.view.Widget.extend({
  ...
  initialize: function() {
    _.bindAll( this, "toggle", "showAllModal", "toggleOk", "onEnter", "updatePlaceholder", "updateValue", "updateType", "createStepTooltip", "closeTooltip", "closeErrorTooltip", "closeFinishTooltip", "closeStepTooltip", "gotoStep" );
