...
describe("core.view", function() {
  ...
  var TestView = nfn.core.View.extend({
    initialize: function() {
  ...
  it("should increment refCount", function() {
      expect(nfn.core.View.viewCount).toEqual(1);
      expect(nfn.core.View.views[view.cid]).toBeTruthy();
  });


  it("should decrement refCount", function() {
      view.clean();
      expect(nfn.core.View.viewCount).toEqual(0);
      expect(nfn.core.View.views[view.cid]).toBeFalsy();
  });
